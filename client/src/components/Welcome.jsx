      ...
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start flex-col mf:mr-10">
          ...
          <div className="grid sm:grid-cols-3 grid-cols-2 w-full mt-10">
            ...
            <div className={`${commonStyles} sm:rounded-none rounded-tr-2xl`}>
              Security
            </div>
            <div className={`sm:rounded-tr-2xl ${commonStyles}`}>Ethereum</div>
            <div className={`sm:rounded-bl-2xl ${commonStyles}`}>Web 3.0</div>
            <div className={`${commonStyles} sm:rounded-none rounded-bl-2xl`}>
              Low fees
            </div>
            <div className={`sm:rounded-br-2xl rounded-br-2xl ${commonStyles}`}>
              Blockchain
            </div>
          </div>
        </div>
